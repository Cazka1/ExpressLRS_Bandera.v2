...
#endif
const fhss_config_t domains[] = {
    {"755-955", FREQ_HZ_TO_REG_VAL(755000000), FREQ_HZ_TO_REG_VAL(955000000), 200},   //hyi
    ...
    {"900-925",  FREQ_HZ_TO_REG_VAL(900000000), FREQ_HZ_TO_REG_VAL(925000000), 50},
    {"FCC915",   FREQ_HZ_TO_REG_VAL(903500000), FREQ_HZ_TO_REG_VAL(926900000), 40}, // default
    {"900-950",  FREQ_HZ_TO_REG_VAL(900000000), FREQ_HZ_TO_REG_VAL(950000000), 100},
    {"950-990",  FREQ_HZ_TO_REG_VAL(950000000), FREQ_HZ_TO_REG_VAL(990000000), 80},
    {"990-1020",  FREQ_HZ_TO_REG_VAL(990000000), FREQ_HZ_TO_REG_VAL(1020000000), 60}
};
